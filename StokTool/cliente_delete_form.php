...
<form action="cliente_delete.php" method="POST">
    ...
    <tr>
        ...
        <td><h1>confirmar exclusão</h1></td>
</table>
        <form class="row g-3 needs-validation" novalidate>
            ...
            <div class="col-md-4" class="qualquer">
                ...
                <input type="text" name="nome" readonly class="form-control" id="nome" value="<?php echo $reg->nome_c;?>" >
            </div>
            
            <div class="col-md-4" class="qualquer">
                <label for="validationCustom01" class="form-label">Logradouro</label>
                <input type="text" name="logradouro"  readonly class="form-control" id="logradouro" value="<?php echo $reg->logradouro;?>">
            </div>
            
            <div class="col-md-4" class="qualquer">
                <label for="validationCustom01" class="form-label">Telefone</label>
                <input type="tel" name="telefone"  readonly class="form-control" id="telefone" value="<?php echo $reg->telefone;?>"><br>

                <?php
 }
                ?>
                <button class="btn btn-primary"  type="submit">excluir cliente</button>
            </div>
