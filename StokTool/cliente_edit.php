        ...
        <div id="corpo">
            ...
            if(!is_logado()){
                ...
                if ($cpfcnpj && $nome && $logradouro && $telefone) {
                    $q = "UPDATE cliente SET nome_c='$nome', logradouro='$logradouro', telefone='$telefone' WHERE cpfcnpj='$cpfcnpj'";
                    ...
                    if($banco->query($q)){
                        ...
                        $mensagem = "Não foi possivel alterar os dados";
