...
<form action="prod_alterar.php" method="POST">
<div class="cardd">
  <table>
    <tr>
      <td><a href="alterar.php"><img src="imagens/arrow-left (1).svg" alt="Voltar"></a></td>
<td><h1>Alterar Produto</h1></td>
</tr>
</table>
<form class="row g-3 needs-validation" novalidate>
  <div class="col-md-4" class="qualquer">
    <label for="validationCustom01"  class="form-label">Nome</label>
    <input type="text" name="nome" class="form-control" id="validationCustom01" value="<?php echo $reg->nome?>">
  ...
  <div class="col-md-4">
    ...
    <input type="text" name="valor" class="form-control" id="valor" value="<?php echo $reg->valor;?>">
    <div class="valid-feedback">
  ...
  <div class="col-md-4" class="qualquer">
    <label for="validationCustom01" class="form-label">Quantidade estoque</label>
    <input type="text" name="qtd_estoq" class="form-control" id="validationCustom01" value="<?php echo $reg->qtd_estoq;?>">
    <div class="valid-feedback">
  ...
  <div class="col-md-4">
    ...
    <input type="file" name="capa" class="form-control" id="validationCustom01" value="<?php echo $reg->imagem?>">
    <div class="valid-feedback">
